...
const CHAR_URL = 'https://api.sheetson.com/v2/sheets/Characters_0.1';
const LEVEL_URL = 'https://api.sheetson.com/v2/sheets/Levels_0.1';
const TALENT_URL = 'https://api.sheetson.com/v2/sheets/Talents_0.12';
const HEADERS = {
